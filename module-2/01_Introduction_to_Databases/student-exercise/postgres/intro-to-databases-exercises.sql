...
SELECT name, population FROM city WHERE district='Montana' and countrycode='USA';
...
SELECT 2020 - indepyear as numbersofyearssinceindependence FROM country WHERE indepyear IS NOT NULL;
